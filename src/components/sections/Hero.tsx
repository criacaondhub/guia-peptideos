...
export function Hero() {
  return (
    <section
      ...
      className={cn(
        'relative flex flex-col justify-start overflow-hidden bg-background px-[var(--spacing-section-x-mobile)] py-[var(--spacing-section-y-mobile)] lg:h-screen lg:flex-row lg:justify-start lg:bg-background-section lg:px-[var(--spacing-section-x-desktop)] lg:py-[var(--spacing-section-y-desktop)]',
        heroClip.className,
      )}
    >
      <img
        src={asset('assets/BANNER-HERO-DESKTOP.webp')}
        alt=""
        width={2000}
        height={1160}
      ...
      <img
        src={asset('assets/BANNER-HERO-MOBILE.webp')}
      ...
      <div className="relative z-10 flex w-full max-w-(--container-max) flex-col items-center justify-center gap-8 text-center lg:ml-[140px] lg:max-w-none lg:items-start lg:gap-7 lg:text-left">
        ...
        <div className="flex w-full flex-col items-center gap-6 lg:w-auto">
          <motion.a
            ...
            className="group relative inline-flex w-full min-h-[64px] items-center justify-center gap-2 overflow-hidden px-6 py-5 text-center font-display leading-none text-white uppercase shadow-lg lg:w-auto lg:gap-3 lg:px-12 lg:py-6 lg:leading-[1.5]"
          >
