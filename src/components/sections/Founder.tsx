...
import { FOUNDER_CONTENT } from '@/config/content'
...
export function Founder() {
  return (
    <section
      ...
      className={cn(
        'relative z-10 flex justify-center bg-background px-[var(--spacing-section-x-mobile)] py-[var(--spacing-section-y-mobile)] lg:px-[var(--spacing-section-x-desktop)] lg:py-[var(--spacing-section-y-desktop)]',
