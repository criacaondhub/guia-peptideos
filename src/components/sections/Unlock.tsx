      ...
      <div className="relative z-10 flex w-full max-w-(--container-max) flex-col items-center gap-10">
        <div className="flex flex-col items-center gap-4 text-center">
          <motion.h2
            ...
            className="font-h2 text-[24px] leading-tight text-text-heading-on-light uppercase lg:text-4xl lg:whitespace-nowrap"
          >
        ...
        <div className="mx-auto grid w-full max-w-[1040px] grid-cols-1 items-stretch gap-4 lg:grid-cols-2 lg:gap-8">
